...
export default function Header({ showSearchBar = false, onSearch, title, turnBack }: HeaderProps) {
      ...
      <Container maxW="90rem" py={4}>
        <Flex align="center" >
          ...
          {title && (
            ...
            borderColor="#DCE2E5" 
            borderRadius="10px"
            ml="34px" onClick={handleTurnBack}> <FaArrowLeft size=".9rem" color="#A0ACB2"/> </Button>
          )}
           {title && (
          <Box 
            position="absolute"
          ...
          {/* Espaço reservado para centralizar a barra */}
